...
def sample_co2_tvoc(rh = 50, temp = 25):
...
if __name__ == '__main__':
    ...
    try:
        ...
        parser.add_argument("-d", action='store_true', help="Run continuously")
        parser.add_argument("-s", type=int,default=10, help="Seconds between readings")
        ...
        while True:           
            rh, temp = sample_rh_temp()
            co2, tvoc = sample_co2_tvoc(rh, temp)
            print(f"{sample_time.replace(microsecond=0).isoformat()},{co2},{tvoc},{rh:.2f},{temp:.2f}")
